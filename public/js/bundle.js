...
},{"./components/client":72,"./components/clientalt":74,"./components/clientlist":76,"./components/clientlistalt":78,"./components/invoice":82,"vue":69,"vue-resource":3}],2:[function(require,module,exports){
...
module.exports = '<h2>Client Form</h2>\n<form>\n    <input type="text" v-model="company" />\n    <button class="btn" v-on="click: addClient">Save</button>\n</form>';
...
module.exports = {
    ...
    methods: {
        addClient: function addClient(event) {
...
},{"./client.html":71}],73:[function(require,module,exports){
...
},{"./clientalt.html":73}],75:[function(require,module,exports){
module.exports = '<h2>Client List</h2>\n<ul>\n    <li v-repeat="clients">{{company}}</li>\n</ul>\n<client clients="{{clients}}"></client>';
...
module.exports = {
    ...
    data: function data() {
        return {
            clients: [{ company: 'Sony Inc.' }, { company: 'Google Inc.' }, { company: 'Samsung Pty Ltd.' }]
        };
    },
    components: {
...
},{"./client":72,"./clientlist.html":75}],77:[function(require,module,exports){
module.exports = '<h2>Client List</h2>\n<ul>\n    <li v-repeat="clients">{{company}}</li>\n</ul>\n<clientalt on-save="{{onClientCreate}}"></clientalt>';
...
module.exports = {
    ...
    methods: {
        onClientCreate: function onClientCreate(data) {
            this.clients.push({ company: data.company });
        }
    }
};

},{"./clientalt":74,"./clientlistalt.html":77}],79:[function(require,module,exports){
module.exports = '<div class="row">\n    {{ content }}\n</div>';
},{}],80:[function(require,module,exports){
'use strict';

module.exports = {
    template: require('./invoice-item.html')
};

},{"./invoice-item.html":79}],81:[function(require,module,exports){
module.exports = '<h2>Invoice Component</h2>\n<p>Main Invoice Details Here</p>\n<invoiceitem v-repeat="items"></invoiceitem>\n<a v-on="click: addItem">Add item</a>';
...
module.exports = {
    ...
    data: function data() {
        return {
            items: [{ content: 'Invoice item 1' }, { content: 'Invoice item 2' }, { content: 'Invoice item 3' }]
        };
    },
    methods: {
...
},{"./invoice-item":80,"./invoice.html":81}]},{},[1]);
